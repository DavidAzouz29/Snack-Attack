...
public class GameState : ScriptableObject
{
	...
	{
		public SnackThinker Snack;
		public int TotalWins;
		[NonSerialized] public GameSettings.PlayerInfo PlayerInfo;

		public bool IsAlive {  get { return Snack && Snack.gameObject.activeSelf; } }
	}
	...
	public PlayerState this[SnackThinker thinker]
	{
		get { return players.FirstOrDefault(p => p.Snack == thinker); }
	}
